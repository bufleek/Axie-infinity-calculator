...
class FloatingWindow(
    ...
    private val rootView = layoutInflater.inflate(R.layout.item_main_popup, null)
    ...
    private val reset = rootView.findViewById<TextView>(R.id.reset_rounds)
    private val next = rootView.findViewById<TextView>(R.id.calculate)
    ...
    private fun initWindow() {
        ...
        rootView.findViewById<ImageButton>(R.id.settings).setOnClickListener {
